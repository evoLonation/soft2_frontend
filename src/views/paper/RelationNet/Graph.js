...
export class Graph {
    ...
    async setLayout() {
        if (this.predictLayout === 'noLayout')
            this.predictLayout = (await GraphLayoutPredict.predict(this.data)).predictLayout;
        this.graph.updateLayout({
            type: this.predictLayout
        })
    }
